...
source scl_source enable devtoolset-6; source /home/opsim/stack/lsstsw/bin/setup.sh; setup sims_ocs git; setup ts_scheduler git; setup ts_astrosky_model git
# if [ $SCHEDULER = "feature" ]; then
#     setup sims_featureScheduler git
# else
